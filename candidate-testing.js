...
for (let i = 0; i < candidateAnswers.length; i++) {
  if (candidateAnswers[i].toLowerCase() === (correctAnswers[i]).toLowerCase()) {
    console.log(`Your answer, --- ${candidateAnswers[i]} --- is CORRECT! The answer was ${correctAnswers[i]}.`)
  } else {
    console.log(`Your answer, --- ${candidateAnswers[i]} --- was WRONG - the correct answer was ${correctAnswers[i]}.`)
  }
}
